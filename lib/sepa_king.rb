...
require 'sepa_king/concerns/attribute_initializer'
require 'sepa_king/concerns/schema_validation'
require 'sepa_king/concerns/xml_builder'
require 'sepa_king/concerns/regulatory_reporting_validator'
require 'sepa_king/account'
require 'sepa_king/account/debtor_account'
require 'sepa_king/account/address'
require 'sepa_king/account/contact_details'
