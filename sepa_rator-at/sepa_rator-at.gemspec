...
Gem::Specification.new do |s|
  s.name          = 'sepa_rator-at'
  s.version       = SEPA::VERSION
  s.authors       = ['AdVitam']
  s.description   = 'Austrian (PSA/Stuzza) XSD schemas for sepa_rator. ' \
                    'Required to validate the at.* profiles.'
  s.summary       = 'Austrian XSD schemas for sepa_rator'
